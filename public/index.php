    ...
    <div class="row g-4 mb-5">
        <div class="col-md-4">
            <div class="card stat-card">
                ...
                <h2 class="fw-bold m-0 text-gradient" style="background: linear-gradient(to right, #1e293b, #0061ff); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
        ...
        <div class="col-md-4">
            <div class="card stat-card">
                ...
                <h2 class="fw-bold m-0 text-gradient" style="background: linear-gradient(to right, #1e293b, #10b981); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
        ...
        <div class="col-md-4">
            <div class="card stat-card">
                ...
                <h2 class="fw-bold m-0 text-gradient" style="background: linear-gradient(to right, #1e293b, #0ea5e9); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
